...
def make_window(theme):
    ...
    asthetic_layout = [[sg.T('Anything that you would use for asthetics in this tab!')],
    ...
    graphing_layout = [[sg.Text("Anything you would use to graph will display here!")],
                       ...
                       [sg.T('Click anywhere on graph to draw circle')],
    ...
    layout = [[sg.MenubarCustom(menu_def, key='-MENU-', font='Courier 15', tearoff= True)],
                [sg.Text('Demo of (Almost) All elements', size=(38,1), justification='ceter', font=('Helvetica', 16), relief=sg.RELIEF_RIDGE, k='-TEXT HEADING-', enable_events=True)]]
